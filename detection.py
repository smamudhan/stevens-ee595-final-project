...
def load_data(data_directory, img_size=(128, 128), batch_size=32):
    ...
    test_dataset = datasets.ImageFolder(os.path.join(data_directory, 'test'), transform=transform)
...
if __name__ == "__main__":
    ...
    data_directory = "path/to/your/data"  # Update with your dataset path
